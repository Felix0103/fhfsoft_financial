...
class LoanEdit extends Component
{
    ...
    public function mount(Loan $loan)
    {
        ...
        $this->selectClient($loan->client);
        $this->start_date = $loan->start_date;
        $this->creation_date = $loan->creation_date;
        $this->subAccountId = $loan->sub_account_id;
        $this->billing_cycle_id = $loan->billing_cycle_id;
        $this->amount = $loan->amount;
        $this->fees_quantity = $loan->fees_quantity;
        $this->rate = $loan->rate;
        $this->loanTypeId = $loan->loan_type_id;
        $this->calcularCuota();
    ...
    public function render()
    {
        ...
        return view('livewire.admin.loan-edit', compact('clients', 'loanCategories', 'loanTypes', 'billingCycles', 'subAccounts'));
    }
    ...
    public function save()
    {
        ...
        try {
            $loan = Loan::create([
                'client_id' => $this->client_id, 'loan_type_id' => $this->loanTypeId, 'sub_account_id' => $this->subAccountId,
