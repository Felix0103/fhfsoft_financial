        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label>{{$current_client?->contact?->phone}} {{$current_client?->contact?->cell_phone??''}}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group"  >
                            <button wire:click="showModalClient"  type="button" class="btn btn-primary" >Buscar cliente</button>
                        </div>
                    </div>
                </div>
